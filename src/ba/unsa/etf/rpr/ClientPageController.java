...

                    {
                        btn.setOnAction((ActionEvent event) -> {
                            ...
                            try {
                                ...
                                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/vehicleDetails.fxml"));
                                VehicleDetailsController vehicleDetailsController = new VehicleDetailsController(vehicle, client);
                                loader.setController(vehicleDetailsController);
                                root = loader.load();
