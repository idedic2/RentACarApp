...
class RentACarDAOTest {
    ...
    void addReservation() {
        ...
        try {
            reservation = new Reservation(0, vehicle, client, LocalDate.of(2020, 9, 17), LocalDate.of(2020, 11, 20), "10:00", "10:00", card1);
    ...
    void addReservation2() {
        ...
        try {
            reservation = new Reservation(0, vehicle, client, LocalDate.of(2020, 9, 17), LocalDate.of(2020, 11, 20), "greška", "10:00", null);
        ...
        try {
            reservation = new Reservation(0, vehicle, client, LocalDate.of(2020, 9, 17), LocalDate.of(2020, 11, 20), "10:00", "greška", null);
        } catch (DateTimeException | NegativeNumberException | InvalidTimeFormatException e) {
            assertEquals("Nevalidno vrijeme vraćanja vozila", e.getMessage());
        }
        try {
            reservation = new Reservation(-6, vehicle, client, LocalDate.of(2020, 9, 17), LocalDate.of(2020, 11, 20), "10:00", "10:00", null);
        } catch (DateTimeException | NegativeNumberException | InvalidTimeFormatException e) {
            assertEquals("Unijeli ste negativan broj", e.getMessage());
        }
        try {
            reservation = new Reservation(0, vehicle, client, LocalDate.of(2020, 9, 17), LocalDate.of(2020, 9, 17), "10:00", "10:00", null);
        } catch (DateTimeException | NegativeNumberException | InvalidTimeFormatException e) {
            assertEquals("Nevalidan format datuma", e.getMessage());
        }
        try {
            reservation = new Reservation(0, vehicle, client, LocalDate.of(2020, 9, 17), LocalDate.of(2020, 5, 10), "10:00", "10:00", null);
        } catch (DateTimeException | InvalidTimeFormatException | NegativeNumberException e) {
            assertEquals("Nevalidan format datuma", e.getMessage());
        }
        try {
            reservation = new Reservation(0, vehicle, client, LocalDate.of(2020, 9, 17), LocalDate.of(2020, 11, 20), "10:00", "10:00", null);
        } catch (DateTimeException | InvalidTimeFormatException | NegativeNumberException e) {
            e.printStackTrace();
        }
        dao.addReservation(reservation);
